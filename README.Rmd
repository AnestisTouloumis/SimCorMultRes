...
## Getting help
A detailed description of **SimCorMultRes** can be found in @Touloumis2016. The vignette of **SimCorMultRes** contains additional examples and it be accessed by executing the following R commands: 

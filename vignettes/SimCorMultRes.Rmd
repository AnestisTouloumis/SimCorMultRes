...
# fitting a GEE model
nominal_gee_model <- nomLORgee(y~x1+x2,data=simulated_nominal_responses$simdata,id=id,repeated=time,LORstr="time.exch")
...
simulated_ordinal_responses <- rmult.clm(clsize = cluster_size, intercepts = beta_intercepts,
                       betas = beta_coefficients, xformula = ~x, cor.matrix = latent_correlation_matrix, link = "probit")
...
# simulation of ordinal responses
simulated_ordinal_responses <- rmult.crm(clsize = cluster_size, intercepts = beta_intercepts, betas = beta_coefficients, 

...
3. Set `betas = 0` in the core functions `rbin` (see Example \@ref(ex:no-covariate)) or `rmult.clm`, or set 0 all values of the `beta` argument that correspond to the category-specific parameters in the core function `rmult.bcl` (see Example \@ref(ex:Example2NoCovariates)).
